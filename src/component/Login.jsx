      ...
      <div className="max-w-md w-full bg-gray-100  p-8 rounded-2xl shadow-lg">
        ...
        <div className="flex justify-center mb-6">
          <button
            ...
            className="flex items-center gap-3 rounded-lg border border-gray-300 bg-black px-5 py-2.5 text-sm font-medium text-gray-700 shadow-sm transition-all duration-200 hover:bg-gray-800 hover:shadow-md focus:outline-none focus:ring-2 focus:ring-blue-5005 w-full justify-center"
          >
